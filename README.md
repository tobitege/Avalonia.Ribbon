...
- In the stacked modes a group container (`RibbonGroupTriple`, `RibbonGroupLines`, `RibbonGroupCluster`) always gets its own column; it used to be stacked below single controls and the column grew beyond the group height.
